...
define(function(require)
{
	...
	return function(deep){
		...
		deep.Collider.add = function(name, fn){
			...
			deep.colliders[name] = deep.Collider.prototype[name] = handler;
		 ...
		 * @example 
		 * var a = {
		 * test:deep.colliders.replace(12)
		 * };
		 * 
		 */
		 ...
		 * @example 
		 * var a = {
		 * test:deep.colliders.copyTo("my.path" ,myObject)
		 * };
		 * 
		 */
		 ...
		 * @example 
		 * var a = {
		 * 	test:deep.colliders.log("my title")
		 * };
		 * 
		 */
		 ...
		 * @example 
		 * var a = {
		 * test:deep.colliders.validate( mySchema )
		 * };
		 * 
		 */
		 ...
		 * @example 
		 * var a = {
		 * test:deep.colliders["array.insertAt"]( what, index )
		 * };
		 * 
		 */
		 ...
		 * @example 
		 * var a = {
		 * test:deep.colliders["array.removeAt"]( index )
		 * };
		 * 
		 */
		 ...
		 * @example 
		 * var a = {
		 * test:deep.colliders.transform( function(input){ return input+2; } )
		 * };
		 * 
		 */
