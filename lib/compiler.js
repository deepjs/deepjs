...
define(["require", "./utils"], function(require, utils) {
	...
	compiler.decorateUpFrom = utils.decorateUpFrom = function(src, target, properties) {
		properties.forEach(function(prop) {
			if (typeof src[prop] !== 'undefined')
				target[prop] = compiler.aup(src[prop], target[prop]);
		});
	};
	compiler.decorateBottomFrom = utils.decorateBottomFrom = function(src, target, properties) {
		properties.forEach(function(prop) {
			if (typeof src[prop] !== 'undefined')
