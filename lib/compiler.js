...
*/
		 ...
		 */
		utils.up = compiler.up = function utilsUp(src, target, parent, key)
		{
		...
		utils.bottom = compiler.bottom = function (src, target, parent, key)
		{
		...
		utils.bottomArray = compiler.bottomArray = function (src, target, schema)
		{
			if(src.length === 0)
				return target;
			var map = {};
		...
		utils.upArray = compiler.upArray = function (src, target, schema)
		{
			if(src.length === 0)
				return target;
			var map = {};
