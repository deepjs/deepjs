...
deep.ui.View = deep.compose.Classes(function(layer){
	...
	//what:"this::!",
	_deep_view_:true,
	how:function(what, routeParams){ return this.toString(); },
	where:"dom.appendTo::#ng-view",
		...
		if(success.placed)
		{
			...
			.each(function(){
				...
				deep.ui.bind(this, $(this).attr("data-bind"), { directPatch:true, callback:null });
			});
	...
	load:function(params){
		...
		if(!this.how || this.condition === false)
				return null;
		if(this.condition)
			if(typeof this.condition === "function" && !this.condition.apply(context))
				return null;
	...
	refresh:function(params, loaded){
		...
		var render = function(loaded){
			...
			var o = { what:what, params:params, getRoute:function(path){} };
			try{
				rendered = o.rendered = how.call(self, o);
				if(where)
					placed = where.call(self, o);
				else
					placed = null;
				o.placed = placed;
			}
			...
			if(placed)
				self.placed = function(){ return placed; };
	...
	toString:function(pretty){ return JSON.stringify(this); }
});
