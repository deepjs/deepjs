...
define(["require", "./utils", "./compiler", "./nodes", "./traversal"], function (require, utils, compiler, nodes, traversal)
{
	...
	flattener.extendsChilds = function (entry, descriptor)
	{
		...
		descriptor = traversal.depthFirst(descriptor || entry, function(value){ return value.backgrounds || value._deep_flattener_; }, {first:true, returnStack:true, excludeLeafs:true });
