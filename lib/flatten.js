...
define(["require"], function (require, deep)
{
	...
	deep.extendsChilds = function extendsChilds(entry, descriptor)
	{
		...
		descriptor = deep.utils.preorder(descriptor || entry, function(){ return this.backgrounds || this._deep_ocm_; }, true, true);
		...
		//console.log("got deep._ocm : ", toExtends.value._deep_ocm_);
		if(toExtends.value._deep_ocm_)
			return toExtends.value.flatten().done(function(){ return entry; });
