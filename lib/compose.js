...
define(["require", "./compiler", "./classes", "./errors", "./utils"], function(require, compiler, classes, errors, utils){
	...
	var composer = {};
	var Composer = composer.Composer = classes.Classes(function(namespace, api){
