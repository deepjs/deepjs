...
define(["require", "./utils", "./errors", "./promise", "./context", "./query"], function(require, utils, errors, Prom, context, Querier) {
	...
	proto.protocol = function(name, ctrl) {
		...
		if (!protoc && Prom.Promise.context.protocols) {
			protoc = Prom.Promise.context.protocols;
