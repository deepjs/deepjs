...
define(["require", "./utils"], function (require, utils) {
	...
	deep.Chain.add = function addChainHandle(name, func) {
		deep.Chain.prototype[name] = func;
		return deep.Chain;
	};
	deep.Chain.add("nodes", function (callBack) {
		var self = this;
		var func = function (s, e) {
	...
	deep.Chain.add("iterate", function (done, fail) {
		var self = this;
		var func = function (s, e) {
	...
	deep.Chain.add("wired", function (args, context, done, fail) {
		var self = this;
		var func = function (s, e) {
			var nodes = null;
	 ...
	 */
	deep.Chain.add("flatten", function () {
		var self = this;
