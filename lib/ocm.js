...
*/
        ...
        deep.generalModes = function(arg, arg2){
        ...
        deep.ocm = function(layer, options)
        {
            ...
            var m = function()
            {
                ...
                if(modes.length === 0 || params.blocked)
                    ...
                    else if(deep.generalModes()[params.group])
                        modes = deep.generalModes()[params.group];
                    else
            ...
            {
                //console.log("ocm.flatten : ", entry.value);
                if(params.blocked)
