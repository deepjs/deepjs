...
define(["require", "./utils", "./nodes/query", "./compiler", "./errors"], function(require, utils, Querier, compiler, errors) {
	/**
	...
	Collider.add("replace", function(input, by, query) {
		if(query)
		{
			Querier.replace(input, query, by);
			return input;
		}
		return by;
	});
