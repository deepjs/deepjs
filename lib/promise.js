...
define(["require", "./utils", "./errors"], function PromiseDefine(require, utils, errors){
    ...
    var Promise = promise.Promise = function (options, context) {
        options = options || {};

        this._context = context || deep.context;

        this._state = options || {};

        this._state.success = options.success || null;
        this._state.error = options.error || null;
        
        this._state.queue = options.queue || [];
        this._state.oldQueue = options.oldQueue || null;
        this._state.handlers = options.handlers || [];
    ...
    promise.Promise.prototype = {
        ...
        close:function(){
            ...
            return this._state.handlers[this._state.handlers.length-1];
        },
        clone:function(){
