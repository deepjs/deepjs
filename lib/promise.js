...
{
    deep.Undefined = { _deep_undefined_:true };
    ...
    deep.when = function deepPromise(arg) {
        ...
        if (typeof arg === "undefined" || arg === null || (!arg.promise && !arg.then))
    ...
    deep.Promise.prototype = {
        ...
        condition: function (cond, handler) {
            ...
            /*
                ...
                .condition(deep.mode.dev, deep.utils.dumpError)
            ...
            var func = function (s, e) {        // WARNING : it's an always
                ...
                {
                    return deep.when(deep.get(handler))
            ...
            func._isDone_ = true;
            return deep.utils.addInChain.call(this, func);
        },
