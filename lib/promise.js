...
define(["require", "./utils", "./errors"], function PromiseDefine(require, utils, errors){
    ...
    promise.Deferred.prototype = {
         ...
         */
        resolve: function resolveDef(argument, context) {
            ...
            this._promises.forEach(function (promise) {
                promise._start(argument, null, context || self._context);
            });
        },
        /**
         ...
         * @return {deep.Deferred} this
         */
        reject: function rejectDef(argument, context) {
            ...
            this._context = context || this._context;
            this._promises.forEach(function (promise) {
                promise._start(null, argument, context || self._context);
            });
        },
        /**
