...
define(["require", "./utils", "./errors", "./promise", "./compose", "./protocol", "./query", "./nodes", "./compiler", "./classes", "./logs", "./deep-equal", "./context", "./sheet", "./validator", "./flatten"], 
function(require, utils, errors, prom, compose, protoc, querier, nodes, compiler, classes, logs, deepEqual, context, sheets, Validator, flattener) {
"use strict";

	//________________________________________________________________________ VALUES CHAIN
	var DeepChain = classes.Classes(prom.Promise,
...
/**
		 ...
		 */
	prom.Promise.API.deep = function(val, schema, options) {
		options = options || {};
		var h = new DeepChain(this._state, options);
		var self = this;
		var func = function(s, e) {
