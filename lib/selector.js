...
define(["require"], function (require) {
    ...
    deep.utils.firstWith = function(root, selector){
        ...
        return deep.utils.preorder(root, func, true);
    };
    ...
    deep.utils.arrayWith = function (root, selector, arrayName)
    {
        ...
        while(q)
        {
            ...
            while(cur)
            {
                var nodes = deep.utils.preorder(cur, function(){ return typeof this[arrayName] !== 'undefined'; });
                var n = nodes.shift();
                while(n)
                {
    ...
    deep.Chain.addHandle("arrayWith", function (selector, name) {
        var self = this;
    ...
    deep.Chain.addHandle("allWith", function (selector) {
        var self = this;
    ...
    deep.Chain.addHandle("firstWith", function (selector) {
        var self = this;
        var func = function (s, e) {
