...
define(["require", "./store", "../utils", "../errors", "../chain", "../promise", "../nodes"], 
function(require, str, utils, errors, chains, prom, nodes) {

    var enqueue = chains.chain.addInChain;
    ...
    chains.Chain.add("store", function(store) {
        ...
        var func = function(s, e) {
            ...
            return  deep
            .when(str.store.prepare(self._storeDef))
            .done(function(st){
                self._store = st;
            });
        };
